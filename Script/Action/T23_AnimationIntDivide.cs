...
public class T23_AnimationIntDivide : UdonSharpBehaviour
{
    public int groupID;
    public int priority;
    public string title;
    ...
    internal class T23_AnimationIntDivideEditor : Editor
    {
        T23_AnimationIntDivide body;
        T23_Master master;
        ...
        void OnEnable()
        {
            body = target as T23_AnimationIntDivide;
        ...
        public override void OnInspectorGUI()
        {
            ...
            body.variable = EditorGUILayout.TextField("Variable", body.variable);
            body.operation = EditorGUILayout.IntField("Operation", body.operation);
    ...
    public void Action()
    {
        if (!RandomJudgement() || operation == 0)
        {
            Finish();
            return;
        }
