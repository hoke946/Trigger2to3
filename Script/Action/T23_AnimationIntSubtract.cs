...
public class T23_AnimationIntSubtract : UdonSharpBehaviour
{
    public int groupID;
    public int priority;
    public string title;
    ...
    internal class T23_AnimationIntSubtractEditor : Editor
    {
        T23_AnimationIntSubtract body;
        T23_Master master;
        ...
        void OnEnable()
        {
            body = target as T23_AnimationIntSubtract;
