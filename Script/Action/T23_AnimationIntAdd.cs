...
public class T23_AnimationIntAdd : UdonSharpBehaviour
{
    public int groupID;
    public int priority;
    public string title;
    ...
    internal class T23_AnimationIntAddEditor : Editor
    {
        T23_AnimationIntAdd body;
        T23_Master master;
        ...
        void OnEnable()
        {
            body = target as T23_AnimationIntAdd;
