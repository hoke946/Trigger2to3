...
public class T23_PickupHaptic : UdonSharpBehaviour
{
    public int groupID;
    public int priority;
    public string title;
    ...
    internal class T23_PickupHapticEditor : Editor
    {
        T23_PickupHaptic body;
        T23_Master master;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (recieverReorderableList == null)
            {
                ...
                recieverReorderableList.drawElementCallback = (rect, index, isActive, isFocused) =>
                {
                    ...
                    body.recievers[index] = (VRC_Pickup)EditorGUI.ObjectField(rect, body.recievers[index], typeof(VRC_Pickup), true);
                };
            }
