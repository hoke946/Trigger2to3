...
public class T23_AnimationIntMultiply : UdonSharpBehaviour
{
    public int groupID;
    public int priority;
    public string title;
    ...
    internal class T23_AnimationIntMultiplyEditor : Editor
    {
        T23_AnimationIntMultiply body;
        T23_Master master;
        ...
        void OnEnable()
        {
            body = target as T23_AnimationIntMultiply;
