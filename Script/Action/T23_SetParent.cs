...
public class T23_SetParent : UdonSharpBehaviour
{
    public int groupID;
    public int priority;
    public string title;
    ...
    internal class T23_SetParentEditor : Editor
    {
        T23_SetParent body;
        T23_Master master;
        ...
        public override void OnInspectorGUI()
        {
            ...
            prop = serializedObject.FindProperty("parent");
