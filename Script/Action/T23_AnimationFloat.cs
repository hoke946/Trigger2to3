...
public class T23_AnimationFloat : UdonSharpBehaviour
{
    public int groupID;
    public int priority;
    public string title;
    ...
    internal class T23_AnimationFloatEditor : Editor
    {
        T23_AnimationFloat body;
        T23_Master master;
        ...
        void OnEnable()
        {
            body = target as T23_AnimationFloat;
        ...
        public override void OnInspectorGUI()
        {
            ...
            body.operation = EditorGUILayout.FloatField("Operation", body.operation);
