...
public class T23_SetLayer : UdonSharpBehaviour
{
    public int groupID;
    public int priority;
    public string title;
    ...
    internal class T23_SetLayerEditor : Editor
    {
        T23_SetLayer body;
        T23_Master master;
        ...
        public override void OnInspectorGUI()
        {
            ...
            prop = serializedObject.FindProperty("layer");
            prop.intValue = EditorGUILayout.LayerField("Layer", body.layer);
