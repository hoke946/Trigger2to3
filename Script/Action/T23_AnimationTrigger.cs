...
public class T23_AnimationTrigger : UdonSharpBehaviour
{
    public int groupID;
    public int priority;
    public string title;
    ...
    internal class T23_AnimationTriggerEditor : Editor
    {
        T23_AnimationTrigger body;
        T23_Master master;
        ...
        public override void OnInspectorGUI()
        {
            ...
            body.trigger = EditorGUILayout.TextField("Trigger", body.trigger);
