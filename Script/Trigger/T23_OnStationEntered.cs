...
public class T23_OnStationEntered : UdonSharpBehaviour
{
    public int groupID;
    public string title;
    ...
    internal class T23_OnStationEnteredEditor : Editor
    {
        T23_OnStationEntered body;
        T23_Master master;
        ...
        void OnEnable()
        {
            body = target as T23_OnStationEntered;
